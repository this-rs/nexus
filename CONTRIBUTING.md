...
2. Create a PR to merge into version branch (e.g., `v0.0`)
3. After merge, create a version tag: `git tag v0.0.0`
4. Push the tag: `git push origin v0.0.0`
...
Pre-release versions: `v0.0.0-alpha.1`, `v0.0.0-beta.1`, `v0.0.0-rc.1`
